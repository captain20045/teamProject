...
$sql = "insert into freeboard_tbl(branch_seq,name,title_board,write_board,insert_day,count_board, user_ip ) 
		       values($selBranch,'$fname','$ftitle','$fwrite','$insert_date',0,'$user_ip')";
