...
if(strlen($searchtext) == 0){	
	...
	$res2 = mysqli_query($connect, "select bno,title_board,name,insert_day,count_board from freeboard_tbl where name like '%$searchtext%' order by bno desc limit $offset, $view_num");
}
