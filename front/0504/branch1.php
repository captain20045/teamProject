...
<head>
    ...
    <link rel="stylesheet" href="css/point1.css" type="text/css">
    <link rel="stylesheet" href="css/point2.css" type="text/css">
...
<div id="branch" class="body">
			...
			<div class="row">
				...
				<div class="col s5 img_area">
					<div class="slider-for slick-initialized slick-slider">
						<div aria-live="polite" class="slick-list draggable">
                             <div class="slick-track" role="listbox" style="opacity: 1; width: 350px;">
                                 <div class="item slick-slide slick-current slick-active" data-slick-index="0" aria-hidden="false" tabindex="-1" role="option" aria-describedby="slick-slide00" style="width: 350px; position: relative; left: 0px; top: 0px; z-index: 999; opacity: 1;">
					...
					<div class="slider-nav slick-initialized slick-slider">
						<div aria-live="polite" class="slick-list draggable">
                             <div class="slick-track" role="listbox" style="opacity: 1; width: 122px; transform: translate3d(0px, 0px, 0px);">
                                 <div class="item slick-slide slick-current slick-active" data-slick-index="0" aria-hidden="false" tabindex="-1" role="option" aria-describedby="slick-slide10" style="width: 107px;">
                                       <img src="https://raw.githubusercontent.com/dudxoor68/teamProject/main/front/img/guli.jpg">
	...
	<footer id="footer">
		...
		<section class="footer_bottom">
			<div class="inner container">
				<div class="site_info">
					<a href="/" class="footer_logo"><img src=""></a>
					<ul class="site_info_1">
		                <li><span>상호명</span> 현생탈출</li>
		                <li><span>주소</span> 경기도 성남시 중원구 광명로 377</li>
		            </ul>
		            <ul class="site_info_2">
		               <li><span>(주)컴퍼니</span> </li>
					   <li><span> 사업자등록번호</span> 000-00-000000</li>
					   <li><span> 통신판매업 신고 </span> 2022-안양동안-202호 </li>
		                <li><span>대표전화</span> 1800.6777  &nbsp;&nbsp;  / &nbsp;&nbsp;  E-mail escape@naver.com</li>
		            </ul>
