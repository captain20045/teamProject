...
(3, 0, 1, 1, '2023-04-18', '2023-03-22', '13', '120', '방탈출', '홍길동', '010-1234-5678', 3, 20000, '카드결제'),
(4, 0, 1, 1, '2023-04-18', '2023-04-01', '15', '120', '방탈출', '홍길동', '010-1234-5678', 3, 20000, '카드결제'),
(5, 0, 1, 1, '2023-04-19', '2023-04-01', '09', '120', '방탈출', '홍길동', '010-1234-5678', 3, 20000, '카드결제');
...
(1, '2023-05-03', 1, 1, 1, 'N', 'Y', 'Y', 'N', 'Y', 'Y', 'Y', 'Y');
...
CREATE TABLE `p_theme` (
  ...
  `theme_people` int(2) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci;
...
(1, 1, 1, '테마이름1', '설명1', '사진주소1', 20000, 2, 3, 'fantasy', '11:00:00', 3),
(2, 1, 1, '테마이름1', '설명1', '사진주소1', 20000, 2, 3, 'fantasy', '13:00:00', 3),
(3, 1, 1, '테마이름1', '설명1', '사진주소1', 20000, 2, 3, 'fantasy', '15:00:00', 3),
(4, 1, 2, '테마이름2', '설명2', '사진주소2', 21000, 1, 5, 'horror', '11:00:00', 4),
(5, 1, 2, '테마이름2', '설명2', '사진주소2', 21000, 1, 5, 'horror', '13:00:00', 4),
(6, 2, 3, '테마이름3', '설명2', '사진주소2', 21000, 1, 5, 'horror', '15:00:00', 4),
(7, 2, 3, '테마이름3', '설명2', '사진주소2', 21000, 1, 5, 'horror', '17:00:00', 4),
(8, 2, 4, '테마이름4', '설명', '사진주소', 20000, 2, 4, 'a', '12:00:00', 4),
(9, 2, 4, '테마이름4', '설명', '사진주소', 20000, 2, 4, 'b', '14:00:00', 4),
(10, 2, 4, '테마이름4', '설명', '사진주소', 20000, 2, 4, 'c', '16:00:00', 4),
(11, 2, 5, '테마이름5', '설명', '사진주소', 20000, 3, 2, 'd', '17:00:00', 4),
(12, 2, 5, '테마이름5', '설명', '사진주소', 20000, 3, 2, 'e', '19:00:00', 4),
(13, 3, 6, '테마이름6', '설명', '사진주소', 30000, 1, 1, 'f', '11:20:00', 4),
(14, 3, 6, '테마이름6', '설명', '사진주소', 30000, 1, 1, 'f', '13:20:00', 4),
(15, 4, 7, '테마이름7', '설명', '사진주소', 30000, 2, 2, 'f', '11:30:00', 4),
(16, 4, 7, '테마이름7', '설명', '사진주소', 30000, 2, 2, 'f', '13:30:00', 4),
(17, 4, 7, '테마이름7', '설명', '사진주소', 30000, 2, 2, 'f', '15:30:00', 4),
(18, 10, 8, '테마이름8', '설명', '사진주소', 40000, 3, 3, 'k', '09:50:00', 4),
(19, 11, 9, '테마이름9', '설명', '사진주소', 40000, 4, 4, 'k', '10:55:00', 4);
...
--
ALTER TABLE `p_reservation`
  MODIFY `reservation_seq` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;

--
-- 테이블의 AUTO_INCREMENT `p_reservation_status`
--
ALTER TABLE `p_reservation_status`
  MODIFY `reservation_status_seq` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;

--
-- 테이블의 AUTO_INCREMENT `p_theme`
--
ALTER TABLE `p_theme`
  MODIFY `theme_seq` int(4) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=20;
COMMIT;
