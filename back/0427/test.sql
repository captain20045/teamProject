...
(6, 1, 2, '테마이름2', '설명2', '사진주소2', 21000, 1, 5, 'horror', '15:00:00'),
(7, 1, 2, '테마이름2', '설명2', '사진주소2', 21000, 1, 5, 'horror', '17:00:00');
...
--
ALTER TABLE `p_theme`
  MODIFY `theme_seq` int(4) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8;
COMMIT;
