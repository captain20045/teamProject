...
(1, '2023-04-01', 0, 0, 1, 'N', 'Y', 'Y', 'N', 'Y', 'Y', 'Y', 'Y');
...
INSERT INTO `p_theme` (`theme_seq`, `branch_seq`, `theme_number`, `theme_name`, `theme_description`, `theme_picture`, `theme_price`, `theme_level`, `theme_scare`, `theme_jenre`, `theme_start`) VALUES
(1, 1, 1, '테마이름1', '설명1', '사진주소1', 20000, 2, 3, 'fantasy', '11:00:00'),
(2, 1, 1, '테마이름1', '설명1', '사진주소1', 20000, 2, 3, 'fantasy', '13:00:00'),
(3, 1, 1, '테마이름1', '설명1', '사진주소1', 20000, 2, 3, 'fantasy', '15:00:00'),
(4, 1, 2, '테마이름2', '설명2', '사진주소2', 21000, 1, 5, 'horror', '11:00:00'),
(5, 1, 2, '테마이름2', '설명2', '사진주소2', 21000, 1, 5, 'horror', '13:00:00'),
(6, 2, 3, '테마이름3', '설명2', '사진주소2', 21000, 1, 5, 'horror', '15:00:00'),
(7, 2, 3, '테마이름3', '설명2', '사진주소2', 21000, 1, 5, 'horror', '17:00:00'),
(8, 2, 4, '테마이름4', '설명', '사진주소', 20000, 2, 4, 'a', '12:00:00'),
(9, 2, 4, '테마이름4', '설명', '사진주소', 20000, 2, 4, 'b', '14:00:00'),
(10, 2, 4, '테마이름4', '설명', '사진주소', 20000, 2, 4, 'c', '16:00:00'),
(11, 2, 5, '테마이름5', '설명', '사진주소', 20000, 2, 4, 'd', '17:00:00'),
(12, 2, 5, '테마이름5', '설명', '사진주소', 20000, 2, 4, 'e', '19:00:00');
...
--
ALTER TABLE `p_theme`
  MODIFY `theme_seq` int(4) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=13;
COMMIT;
