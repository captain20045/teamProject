            ...
            <div class="col s3">
               ...
               <div class="tit"><?= $data['branch_name'] ?></div>
                 <div class="btns center">
                      ...
                      <a href="reservation.php" class="btn"><i class="ico left cal_black"></i>예약하기
                      <form method="post" action="reservation.php">
                      <input type="hidden" name="selectedRegion" value=<?= $data['region_seq'] ?>>
                      <input type="hidden" name="selectedBranch" value=<?= $data['branch_seq'] ?>>
                      </form>
                    </a>
